...
const ReciterSurhaItem = ({style, item, onPress}) => {
  return (
      ...
      <TouchOpactiyIndex
        ...
        <View style={styles.vuContainTexts}>
          <View style={styles.vuTitle}>
            <Text style={styles.lblTitle}>SurhaName</Text>
            <Text style={styles.lblSurhaNum}>(Surha no.1)</Text>
          </View>
          <Text style={styles.lblAyatNum}>Number of Ayat 7</Text>
        </View>
        <View>
...
export default ReciterSurhaItem;
